#!/usr/bin/env python3
"""Runner for the 'onboarding-decline' scenario.

See test-harness/scenarios/onboarding-decline.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'detect': ['onboarding_started', 'protocol_installed'], 'interview': ['decline_acknowledged'], 'verify': ['agents_md_present', 'dialog_file_present', 'no_state_written', 'recommendations_file_present']}
