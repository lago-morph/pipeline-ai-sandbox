...
See test-harness/scenarios/batch-job-happy-path.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'setup': ['issue_number_present', 'repo_created'], 'invoke': ['batch_job_comment_present', 'envelope_run_status'], 'verify': ['envelope_run_status', 'error_kind_absent', 'summary_keys_present']}
