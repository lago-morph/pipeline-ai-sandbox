...
See test-harness/scenarios/task-dag-stale-takeover.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'setup': ['issue_locked', 'issue_number_present'], 'claim': ['claim_succeeded', 'previous_agent_evicted'], 'verify': ['meta_agent_id', 'meta_status']}
