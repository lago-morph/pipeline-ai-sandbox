...
See test-harness/scenarios/orchestrate-issue-restart-recovery.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'setup': ['issue_number_present'], 'fanout': ['orchestrator_killed_mid_fanout', 'subagents_dispatched'], 'restart': ['no_duplicate_dispatch', 'restart_acknowledged'], 'finalise': ['pr_opened'], 'verify': ['meta_status', 'pr_merged']}
