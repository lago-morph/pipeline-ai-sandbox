#!/usr/bin/env python3
"""Runner for the 'onboarding-blank-repo' scenario.

See test-harness/scenarios/onboarding-blank-repo.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'detect': ['agents_md_present', 'onboarding_started', 'protocol_installed'], 'interview': ['dialog_file_present', 'questions_answered'], 'recommend': ['no_agents_md_edits_proposed', 'recommendations_file_present'], 'apply': ['pointer_added_to_agents_md', 'protocol_templates_installed'], 'verify': ['dialog_file_committed', 'meta_status']}
