...
See test-harness/scenarios/batch-job-runner-pickup-timeout.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'setup': ['issue_number_present'], 'invoke': ['batch_job_comment_present'], 'verify': ['envelope_run_status', 'error_kind']}
