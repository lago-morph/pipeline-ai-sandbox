#!/usr/bin/env python3
"""Runner for the 'composition-guide-render' scenario.

See test-harness/scenarios/composition-guide-render.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'render': ['frontmatter_parses', 'markdown_renders'], 'lint': ['all_referenced_skills_exist', 'no_broken_external_links', 'no_broken_internal_links']}
