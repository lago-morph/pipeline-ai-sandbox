...
See test-harness/scenarios/batch-job-branch-sha-mismatch.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'setup': ['branch_created', 'issue_number_present'], 'invoke': ['batch_job_comment_present'], 'verify': ['envelope_run_status', 'error_kind']}
