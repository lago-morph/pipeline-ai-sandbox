...
See test-harness/scenarios/orchestrate-issue-single-subagent.yml for the scenario spec and
...
PHASE_EXPECTED_KEYS = {'setup': ['issue_number_present'], 'claim': ['issue_locked'], 'fanout': ['subagents_dispatched'], 'merge': ['feature_branch_advanced', 'pr_opened'], 'verify': ['meta_status', 'pr_merged']}
